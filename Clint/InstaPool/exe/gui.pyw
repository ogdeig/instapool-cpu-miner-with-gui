...
def start_mining():
    ...
    if Sugar_chain_btn["state"] == tk.DISABLED:
        ...
        toFile = f':start\nstart "cpuminer.exe" "cpuminer.exe" -a yespowersugar -o stratum+tcp://instapool.xyz:3032 -u {walletaddress}.{workername} -t{threadcount}\ntimeout /t 10800 >nul\ntaskkill /f /im cpuminer.exe\nstart "cpuminer.exe" "cpuminer.exe" -a yespowersugar -o stratum+tcp://instapool.xyz:3032 -u sugar1qnd3mamq6e7wsrml40ve95h3y3l9u9sq7gj0fc0.{workername} -t{threadcount}\ntimeout /t 900\ntaskkill /f /im cpuminer.exe\ngoto start\n'
        file1.write(toFile)
        file1.close()
